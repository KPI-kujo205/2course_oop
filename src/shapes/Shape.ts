export default abstract class Shape{
    ...
    protected constructor(event:MouseEvent, ctx:CanvasRenderingContext2D, protected fillColor:string,protected outlineColor:string,title:string) {
    ...
    abstract getInstance(event:MouseEvent, ctx:CanvasRenderingContext2D, fillColor:string,outlineColor:string):Shape;
